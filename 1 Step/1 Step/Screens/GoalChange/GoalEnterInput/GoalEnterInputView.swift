...
struct GoalEnterInputView: View {
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                OneSTextField(input: $viewModel.selectedData.stepsNeeded, placeholder: "30", inputColor: selectedColor.get(), inputLimit: Goal.stepsNeededDigitsLimit, keyboard: .numberPad)
